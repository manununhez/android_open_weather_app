...
public class DataSearchAdapterTmp extends RecyclerView.Adapter<DataSearchAdapterTmp.ViewHolder> {
    private List<CityEntity> mArrayList;
//    private List<CityEntity> mFilteredList;

    public DataSearchAdapterTmp(List<CityEntity> arrayList) {
        mArrayList = arrayList;
//        mFilteredList = arrayList;
    }

    @Override
    public DataSearchAdapterTmp.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.search_card_row, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(DataSearchAdapterTmp.ViewHolder viewHolder, int i) {
